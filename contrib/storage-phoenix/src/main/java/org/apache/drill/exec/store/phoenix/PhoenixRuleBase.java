...
abstract class PhoenixRuleBase extends ConverterRule {
      ...
      .build(
          new CacheLoader<RexNode, Boolean>() {
            public Boolean load(RexNode expr) {
              return PhoenixExpressionCheck.isOnlyStandardExpressions(expr);
            }
          });

  protected final JdbcConvention out;

  private PhoenixRuleBase(Class<? extends RelNode> clazz, RelTrait in, JdbcConvention out, String description) {
    super(clazz, in, out, description);
    this.out = out;
  }

  static class DrillJdbcProjectRule extends PhoenixRuleBase {
  ...
  static class DrillJdbcFilterRule extends PhoenixRuleBase {
