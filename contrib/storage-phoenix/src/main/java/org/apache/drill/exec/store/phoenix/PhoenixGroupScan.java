...
public class PhoenixGroupScan extends AbstractGroupScan {
  ...
  PhoenixGroupScan(String name, PhoenixStoragePlugin plugin, double rows) {
    super("");
    this.name = name;
    this.plugin = plugin;
    this.rows = rows;
  ...
  public SubScan getSpecificScan(int minorFragmentId) throws ExecutionSetupException {
    return new PhoenixSubScan(name, plugin);
  }
  ...
  public String getDigest() {
    return name + String.valueOf(plugin.getConfig());
  }
  ...
  public PhysicalOperator getNewWithChildren(List<PhysicalOperator> children) throws ExecutionSetupException {
    return new PhoenixGroupScan(name, plugin, rows);
  }
